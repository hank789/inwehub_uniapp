	...
	<view>
					...
					<block v-if="row.type=='user'">
						...
						<view class="my" v-if="row.msg.userinfo.uid==myuid">
							...
							<view class="left">
								...
								<view v-if="row.msg.type=='voice'" class="bubble voice" @tap="playVoice(row.msg)" :class="playMsgid == row.msg.id?'play':''">
									...
									<view class="chat-icon my-voice"></view>
								</view>
								<!-- 图片消息 -->
						...
						<view class="other" v-if="row.msg.userinfo.uid!=myuid">
							...
							<view class="right">
								...
								<!-- 语音消息 -->
								<view v-if="row.msg.type=='voice'" class="bubble voice" @tap="playVoice(row.msg)" :class="playMsgid == row.msg.id?'play':''">
									<view class="chat-icon other-voice"></view>
									<view class="length">{{row.msg.content.length}}</view>
								</view>
								<!-- 图片消息 -->
								<view v-if="row.msg.type=='img'" class="bubble img" @tap="showPic(row.msg)">
		...
		<view class="popup-layer" :class="popupLayerClass" @touchmove.stop.prevent="discard">
			...
			<view class="more-layer" :class="{hidden:hideMore}">
				<view class="list">
					<view class="box" @tap="chooseImage"><view class="chat-icon tupian2"></view></view>
					<view class="box" @tap="camera"><view class="chat-icon paizhao"></view></view>
					<view class="box" @tap="handRedEnvelopes"><view class="chat-icon hongbao"></view></view>
				</view>
			</view>
		</view>
		<!-- 底部输入栏 -->
		<view class="input-box" :class="popupLayerClass" @touchmove.stop.prevent="discard">
			...
			<!-- #ifndef H5 -->
			<view class="voice">
				<view class="chat-icon" :class="isVoice?'jianpan':'yuyin'" @tap="switchVoice"></view>
			</view>
			<!-- #endif -->
			<!-- #ifdef H5 -->
			<view class="more" @tap="showMore">
				<view class="chat-icon add"></view>
			</view>
			<!-- #endif -->
			<view class="textbox">
				...
				<view class="text-mode"  :class="isVoice?'hidden':''">
					...
					<view class="em" @tap="chooseEmoji">
						<view class="chat-icon biaoqing"></view>
					</view>
				</view>
			</view>
			<!-- #ifndef H5 -->
		...
		<view class="record" :class="recording?'':'hidden'">
			<view class="ing" :class="willStop?'hidden':''"><view class="chat-icon luyin2" ></view></view>
			<view class="cancel" :class="willStop?'':'hidden'"><view class="chat-icon chehui" ></view></view>
				...
				<view class="open-redenvelope">
					<view class="top">
						<view class="close-btn">
							<view class="chat-icon close" @tap="closeRedEnvelope"></view>
						</view>
					...
					<view class="showDetails" @tap="toDetails(redenvelopeData.rid)">
						查看领取详情 <view class="chat-icon to"></view>
					</view>
				</view>
			</view>
...
<script>
	export default {
		...
		onLoad(option) {
			var contact_id = option.contact_id
			var room_id = option.room_id
			if (contact_id) {
				this.$request.post('im/getWhisperRoom',{contact_id: contact_id}).then(response => {
					...
					this.chatRoomId = response.data.room_id
          this.name = response.data.contact_name
				})
			}
			this.getMsgList();
			//语音自然播放结束
