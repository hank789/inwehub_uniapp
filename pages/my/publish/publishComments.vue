	...
	<view class="content">
		...
		<view class="mui-content">
			<view class="container-searchMenu">
				...
				<text class="tabText font-family-medium">点评<text class="underline"></text></text>
				<text class="bot"></text>
			</view>

			<iwList v-model="list" :api="'readhub/mySubmission'" :cssTop="88" :requestData="{uuid: '27707c887b4911e8b73500163e000d6b', type: 2}">

				<view class="container-publishComment">
					<view class="container-commentWrapper" v-for="(ask, index) in list" :key="index" @tap.stop.prevent="goToCommentPage(ask.type, ask.comment_url)">
						<view class="container-commentList">
							<view class="title text-line-1" v-html="ask.title"></view>
							<view class="content text-line-1" v-html="ask.category_name"></view>
							<view class="time">
								<text>{{ask.created_at}}</text>
							</view>
							<text class="bot"></text>
						</view>
					</view>
