<template>
	<view class="content">
		...
		<view class="mui-content">
			...
			<iwList v-model="list" :api="'answer/myList'" :cssTop="88" :requestData="{uuid: '27707c887b4911e8b73500163e000d6b', return_type: 1}">
				<view class="answer">
...
<script>
	...
	export default {
		...
		methods: {
			...
			getMyAnswerList() {
				getAnswerList('27707c887b4911e8b73500163e000d6b', 1, (res) => {
					this.list = res
				})
			}
		}
