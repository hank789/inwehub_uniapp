<template>
	<view>
		<view class="mui-content searchSubmission">
			<RefreshList ref="refreshlist" v-model="list" :api="'search/reviews'" :page-mode="true"
			 :request-data="dataList" class="listWrapper">

				<template v-for="(item, index) in list">
					<DianPingFeed :item="item" :is-show-link="true" :key="index" @showPageMore="showItemMore" />
				</template>
...
<script>
	...
	import {
		searchText as searchTextFilter
	} from '@/lib/search'
